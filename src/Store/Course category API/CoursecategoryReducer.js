import {
  ALLCOURSECATEGORY_FAIL,
  ALLCOURSECATEGORY_REQUEST,
  ALLCOURSECATEGORY_SUCCESS,
  CREATECOURSECATEGORY_FAIL,
  CREATECOURSECATEGORY_REQUEST,
  CREATECOURSECATEGORY_SUCCESS,
  DELETECOURSECATEGORY_FAIL,
  DELETECOURSECATEGORY_REQUEST,
  DELETECOURSECATEGORY_SUCCESS,
  GET_COURSECATEGORY_FAIL,
  GET_COURSECATEGORY_REQUEST,
  GET_COURSECATEGORY_SUCCESS,
  UPDATE_COURSECATEGORY_FAIL,
  UPDATE_COURSECATEGORY_REQUEST,
  UPDATE_COURSECATEGORY_SUCCESS,
} from "./actionType";
